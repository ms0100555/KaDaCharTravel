                  ...
                  <table class="table table-striped table-bordered table-hover dataTables-example" >
                    <tbody>
                      <?php
                        ...
                        $data = sqlQry("SELECT * FROM hotel ",array());
                        foreach ($data as $key) {
                          echo "<tr>";
                          echo "<td rowspan='4' class='attractions_picture'><img src= ".$key['Picture']. " height='150' width='200'></td>";
                          echo "</tr>";

                          echo "<tr>";
                          echo "<td>連絡電話</td>";
                          echo "<td><a href = 'hotel_in.php?id=".$key['A_ID']."'>".$key['A_Name']."</a></td>";
                          echo "</tr>";

                          echo "<tr>";
                          echo "<td>連絡電話</td>";
                          echo "<td>".$key['A_Tel']."</td>";
                          echo "</tr>";

                          echo "<tr>";
                          echo "<td>景點地點</td>";
                          echo "<td>".$key['A_Add']."</td>";
                          echo "</tr>";
                        }
                      ?>
                    </tbody>
