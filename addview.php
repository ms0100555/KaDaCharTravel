        ...
        <ul class="nav metismenu" id="side-menu">
          ...
          <li class="active">
            ...
            <ul style="" class="nav nav-second-level collapse in">
              ...
              <li style="font-size:16px;" class="active"><a href="addview.php">新增景點資訊</a></li>
...
<?php
  if(isset($_POST["action"])&&($_POST["action"]=="add")){
    ...
    if($ID==null){
      ...
      $IDCheck = sqlQry("SELECT * FROM view WHERE A_ID=? ",array($ID));
      ...
      if (!empty($IDCheck)) {
        ...
        $data_row = sqlEdit("INSERT INTO view (`A_ID`,`A_Name`,`Picture`,`A_Tel`,`A_Add`,`A_Open_Time`,`A_Content`,`Lat`,`Lng`) VALUES (?,?,?,?,?,?,?,?,?)",$data);
