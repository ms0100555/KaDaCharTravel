    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
          ...
          <li class="active">
              <a href="view.php"><i class="fa fa-database" style="font-size:18px;"></i> <span style="font-size:18px;" class="nav-label">資料維護</span></a>
              ...
              <li style="font-size:16px;" class="active"><a href="hotel.php">旅館清單資訊</a></li>
                ...
                <div class="table-responsive">
                  <?php
                    ...
                    if(isset($_POST["login"])&&($_POST["login"]=="go")){
                      ...
                      $data = array($post_Name,$post_Content,$post_Phone,$post_Add,$post_Photo,$post_Web,$post_Lat,$post_Lng,$post_ID);
                      $sql_status = sqlEdit("UPDATE hotel SET `A_Name` = ?,`A_Content` =? ,`A_Tel` = ?,`A_Add` =?,`Picture` =?  ,`Web` =? ,`Lat` = ? ,`Lng` = ?  WHERE A_ID =? ;",$data);
                      $data1 = array($post_Name,$post_Content,$post_Phone,$post_Add,$post_Photo,$post_Web,$post_Lat,$post_Lng,$post_ID);
                      $sql_status1 = sqlEdit("UPDATE attractions SET `A_Name` = ?,`A_Content` = ?,`A_Tel` = ?,`A_Add` = ?,`Picture` = ? ,`Web` =? ,`Lat` = ? ,`Lng` = ? WHERE A_ID = ?",$data1); 
                      ...
                      echo "</script>";
                      echo "<script>";
                      echo "document.location.href='hotel.php';";
                      echo "</script>";
                    }
                  ?>
...
<tr>
<th>網址</th>
<td width = "800" height="50"><input type="text" name="Web" value= "<?php echo $Web;?>" size = "33"></td>
</tr>
<tr>
<th>景點介紹</th>
<td width = "800" height="40"><textarea size="300" style='width:250px ;height:400px' type="text" name="Content"><?php echo $Content;?></textarea></td>
</tr>
<tr>
<th>經度</th>
