    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
          ...
          <li>
              <a href="s_route_basic.php"><i class="fa fa-calendar" style="font-size:18px;"></i> <span style="font-size:18px;" class="nav-label">行程管理</span></a>
          </li>
        </ul>
      </div>
    </nav>
                ...
                <div class="table-responsive">
                  <?php
                    ...
                    if(isset($_POST["login"])&&($_POST["login"]=="go")){
                      ...
                      $sql_status = sqlEdit("UPDATE food SET `Name` = ?,`Description` = ?,`Tel` = ?,`Add` = ?,`Picture1` = ? ,`Px` = ? ,`Py` = ? WHERE Id = ?",$data); 
                      ...
                      echo "</script>";
                      echo "<script>";
                      echo "document.location.href='food.php';";
                      echo "</script>";
                    }
                  ?>
