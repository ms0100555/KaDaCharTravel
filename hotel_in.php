                  ...
                  <table class="table table-striped table-bordered table-hover dataTables-example" >
                    <tbody>
                      <?php
                        ...
                        $data = sqlQry("SELECT * FROM hotel WHERE A_ID = ?",array($ID));
                        echo "<h1>".$data[0]['A_Name']."</h1>";
                        echo "<td> <a href = 'hotelupdate.php?ID=".$ID." & Name=".$data[0]['A_Name']."& Photo=".$data[0]['Picture']."& Phone=".$data[0]['A_Tel']."& Add=".$data[0]['A_Add']."& Content=".$data[0]['A_Content']."& Web=".$data[0]['Web']."& Lat=".$data[0]['Lat']."& Lng=".$data[0]['Lng']."'> 修改景點資訊 </a> </td>";
                        ...
                        echo "<tr>";
                        if($data[0]['Web'] == ""){
                          echo "<td colspan = '2' height='50'>網址：無</td>";
                        }else{
                          echo "<td colspan = '2' height='50'>網址：<a target='_blank' href='".$data[0]['Web']."'>前往</a></td>";
                        }
                        echo "</tr>";
