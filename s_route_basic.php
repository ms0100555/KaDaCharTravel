                  ...
                  <table class="table table-striped table-bordered table-hover dataTables-example" >
                    <tbody>
                      <?php
                       ...
                       $data = sqlQry("SELECT * FROM s_route_basic ",array());
                       foreach ($data as $key ) {
                        ...
                        echo "<th width='50' height = '20' bgcolor= '#a3cf62' >".'名稱：'."</th>"."<td  width='250 ' height = '20' bgcolor= '#a3cf62'>"."<a href = 's_route_content.php?id=".$key['R_ID']."'>".$key['R_Name']."</a>"."</td>";
  ...
  <script>
    ...
    for (var i = 0 ; i < btn.length; i++) {
      btn[i].onclick = function(){
          if (confirm ("確定刪除嗎?")) {
              location.href = "s_delete_route.php?id="+this.dataset.id;//跳頁並傳值
          }
          else{
