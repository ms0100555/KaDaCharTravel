        ...
        <ul class="nav metismenu" id="side-menu">
          ...
          <li>
            ...
            <ul style="" class="nav nav-second-level collapse">
              <li><a href="staff.php" style="font-size:16px;">管理員清單</a></li>
              <li><a href="addstaff.php" style="font-size:16px;">新增管理員</a></li>
              <li><a href="user.php" style="font-size:16px;">使用者清單</a></li>
            </ul>
          </li>
          <li class="active">
            ...
            <ul style="" class="nav nav-second-level collapse in">
              ...
              <li class="active" style="font-size:16px;"><a href="food.php">美食清單資訊</a></li>
...
<?php
  if(isset($_POST["action"])&&($_POST["action"]=="add")){
    ...
    if($ID==null){
      ...
      $IDCheck = sqlQry("SELECT * FROM food WHERE A_ID=? ",array($ID));
      ...
      if (!empty($IDCheck)) {
        ...
        $data = array($ID,$Name,$Picture,$Phone,$Add,$OpenTime,$Content,$Lat,$Lng);
        $data_row = sqlEdit("INSERT INTO food (`Id`,`Name`,`Picture1`,`Tel`,`Add`,`Opentime`,`Description`,`Px`,`Py`) VALUES (?,?,?,?,?,?,?,?,?)",$data);
        $data1 = array($ID,$Name,$Picture,$Phone,$Add,$OpenTime,$Content,$Lat,$Lng);
        $data_row1 = sqlEdit("INSERT INTO attractions (`A_ID`,`A_Name`,`Picture`,`A_Tel`,`A_Add`,`A_Open_Time`,`A_Content`,`Lat`,`Lng`) VALUES (?,?,?,?,?,?,?,?,?)",$data1);
        echo "<script>";
        echo "alert('新增成功！')";
        echo "</script>";
